...
//
      ...
      while (true) {
         ...
         if (p1Card.getCard() > p2Card.getCard()) {//if player 1 win 
            ...
            System.out.println("Player 1 wins the round and Player 2's cards: " + p1Card.toString());
            System.out.println();
         }//end if
            ...
            System.out.println("Player 2 wins the round and Player 1's card : " + p2Card.toString());
            System.out.println();
         }//end else if
